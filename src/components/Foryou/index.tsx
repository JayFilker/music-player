...
export function Foryou() {
    ...
    return <div className="for-you-row">
        <div className="daily-recommend-card">
            ...
            <div className="container">
                <div className="title-box">
                    <div className="title"><span>每</span><span
                    >日</span><span>推</span><span>荐</span></div>
                </div>
            </div>
            ...
            >
                <SvgIcon>
                    <svg
                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="svg-inline--fa fa-play fa-w-14"
        ...
        >
            ...
            <div  className="right-part">
                <div  className="info">
                    ...
                    <div  className="artist"><span
                         className="artist-in-line"
                    >  <span ><a
                        href="#/artist/12448205" id="info-span"
                    >永彬Ryan.B</a></span></span>
                    </div>
                </div>
                <div  className="controls" style={{paddingLeft: '0px', paddingRight: '0px'}}>
                    <div  className="buttons">
                        <ButtonIcon classname='button-icon' title='不喜欢' sty={{width: '40px', height: '40px'}}
                            onClick={() => {
                                setLinkDemo(true)
                        ...
                        >
                            <SvgIcon> <svg
                                ...
                                className="svg-inline--fa fa-thumbs-down fa-w-16" role="img"
                                viewBox="0 0 512 512" id="icon-thumbs-down"
                            >
                                <path
                                    fill="currentColor"
                        ...
                        <ButtonIcon classname='button-icon play' title='播放' sty={{width: '40px', height: '40px'}}
                            onClick={() => {
                                setLinkDemo(true)
                        ...
                        >
                            ...
                            >
                                ...
                                <svg
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                    className="svg-inline--fa fa-pause fa-w-14" role="img" viewBox="0 0 448 512"
                                    id="icon-pause"
                                    style={{display: isPlayingTwo ? '' : 'none'}}
                                >
                                    <path
                        ...
                        <ButtonIcon classname='button-icon ' title='下一首' sty={{width: '40px', height: '40px'}}
                            onClick={() => {
                                setLinkDemo(true)
                                setIsPlayingTwo(true)
                                setBadLikeDemo(true)
                    ...
                    <div  className="card-name">
                       <SvgIcon><svg
                           ...
                           viewBox="0 0 512 512" className="svg-inline--fa fa-radio-alt fa-w-16 fa-7x"
                           id="icon-fm"
                       >
                           <path
                               fill="currentColor"
