        ...
        <div className="controls">
            ...
            <div className="middle-control-buttons">
                ...
                <div className="container">
                    ...
                    > <svg
                        ...
                        className="svg-inline--fa fa-thumbs-down fa-w-16" role="img" viewBox="0 0 512 512"
                        id="icon-thumbs-down"
                    >
                        <path
                            fill="currentColor"
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            className="svg-inline--fa fa-play fa-w-14" role="img" viewBox="0 0 448 512"
                            id="icon-play"
                        >
                            <path
                                fill="currentColor"
                    ...
                    <ButtonIcon classname="play" sty={{display:isPlaying ? '' : 'none'}} title='暂停'
                        onClick={()=>{
                            playSong()
                            if(linkDemo) {
                    ...
                    ><SvgIcon
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="svg-inline--fa fa-pause fa-w-14" role="img" viewBox="0 0 448 512" id="icon-pause"><path fill="currentColor" d="M144 479H48c-26.5 0-48-21.5-48-48V79c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v352c0 26.5-21.5 48-48 48zm304-48V79c0-26.5-21.5-48-48-48h-96c-26.5 0-48 21.5-48 48v352c0 26.5 21.5 48 48 48h96c26.5 0 48-21.5 48-48z"></path></svg>
                    </SvgIcon></ButtonIcon>
                    <ButtonIcon
                        title='下一首'
                        onClick={() => {
            ...
            <div className="right-control-buttons">
                ...
                <div className="container">
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" viewBox="0 0 512 512"
                            className="svg-inline--fa fa-list-music fa-w-16 fa-9x" id="icon-list"
                        >
                            <path
                                fill="currentColor"
                    ...
                    <ButtonIcon
                        ...
                        onClick={() => {setMusicList(musicList.map((item, index) => index === 1 ? !item : item))}}
                    ><SvgIcon
                    >
                        <svg className="dn color-inherit link hover-pink" id="icon-repeat">
                            <svg
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                data-prefix="fas" data-icon="repeat" role="img" viewBox="0 0 512 512"
                    ...
                    <ButtonIcon
                        ...
                        onClick={() => {setMusicList(musicList.map((item, index) => index === 2 ? !item : item))}}
                    ><SvgIcon
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            className="svg-inline--fa fa-random fa-w-16" role="img" viewBox="0 0 512 512"
                            id="icon-shuffle"
                        >
                            <path
                                fill="currentColor"
                    ...
                    <div className="volume-control">
                        ...
                        ><SvgIcon
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="svg-inline--fa fa-volume-mute fa-w-16" role="img" viewBox="0 0 512 512" id="icon-volume-mute"><path fill="currentColor" d="M215.03 71.05L126.06 160H24c-13.26 0-24 10.74-24 24v144c0 13.25 10.74 24 24 24h102.06l88.97 88.95c15.03 15.03 40.97 4.47 40.97-16.97V88.02c0-21.46-25.96-31.98-40.97-16.97zM461.64 256l45.64-45.64c6.3-6.3 6.3-16.52 0-22.82l-22.82-22.82c-6.3-6.3-16.52-6.3-22.82 0L416 210.36l-45.64-45.64c-6.3-6.3-16.52-6.3-22.82 0l-22.82 22.82c-6.3 6.3-6.3 16.52 0 22.82L370.36 256l-45.63 45.63c-6.3 6.3-6.3 16.52 0 22.82l22.82 22.82c6.3 6.3 16.52 6.3 22.82 0L416 301.64l45.64 45.64c6.3 6.3 16.52 6.3 22.82 0l22.82-22.82c6.3-6.3 6.3-16.52 0-22.82L461.64 256z"></path></svg>
                        ...
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                className="svg-inline--fa fa-volume-down fa-w-12" role="img" viewBox="0 0 384 512"
                                id="icon-volume-half"
                            >
                                <path
                                    fill="currentColor"
                        ...
                        ><SvgIcon
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" viewBox="0 0 480 512" className="svg-inline--fa fa-volume fa-w-15 fa-2x" id="icon-volume">
                            <path
                                fill="currentColor"
                    ...
                    >
                        <svg
                            ...
                            viewBox="0 0 32 32" id="icon-arrow-up"><path d="M18.221,7.206l9.585,9.585c0.879,0.879,0.879,2.317,0,3.195l-0.8,0.801c-0.877,0.878-2.316,0.878-3.194,0  l-7.315-7.315l-7.315,7.315c-0.878,0.878-2.317,0.878-3.194,0l-0.8-0.801c-0.879-0.878-0.879-2.316,0-3.195l9.587-9.585  c0.471-0.472,1.103-0.682,1.723-0.647C17.115,6.524,17.748,6.734,18.221,7.206z" fill="currentColor"></path></svg>
                    </SvgIcon></ButtonIcon>
                </div>
            </div>
        </div>
